        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form class="form-horizontal" method="post" action="registerProcess" enctype="multipart/form-data" onsubmit="return validateForm()" name="formRegister">
                            ...
                            <div class="form-group">
                                ...
                                <div class="cols-sm-10">
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" name="full_name" id="fullname" placeholder="Enter your Fullname" />
                                    </div>
                                </div>
...
<script>
    function validateForm() {
        ...
        if(password == "") {
            document.getElementById("error_password").innerHTML = "password must not be left blank";
            flag =  false;
        }else if (password < 5) {
            document.getElementById("error_password").innerHTML = "password cannot be less than 5 character";
            flag =  false;
        }
        return flag;
    }
