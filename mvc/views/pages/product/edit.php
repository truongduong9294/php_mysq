        ...
        <div class="row">
            <div class="col-md-9">
                <div class="card card-primary">
                    <form action="../editProductProcess/<?php echo $data['product']['product_id'] ?>" onsubmit="return validateForm()" method="POST" enctype="multipart/form-data" name="formProduct">
                        <div class="card-body">
                        ...
                        <div class="card-body">
                            ...
                            <img style="width: 50%;" src="<?php echo '../../uploads/'.$data['product']['picture'] ?>" alt="">
                            </div>
                        </div>
